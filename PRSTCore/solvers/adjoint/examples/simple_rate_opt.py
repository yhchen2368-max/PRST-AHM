"""Simple rate optimization example.

1:1 Python translation of MRST solvers/adjoint/examples/simpleRateOpt.m
"""
...
def simple_rate_opt():
    """Simple rate optimization using adjoint gradients."""
    ...
    controls = init_controls(schedule, controllable_wells=[0],
                              rate_min_max=[0.001, 0.1], num_control_steps=5)
